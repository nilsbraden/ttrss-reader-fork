 ...
 *
 * <p>
 * Keep the cipher suite list as small as possible. If you advertise all available ciphers (similar to Flaschen's
 * list),
 ...
 * with Java's supported cipher suites. For example, here's the list I get when preparing to connect or microsoft.com
 * or
