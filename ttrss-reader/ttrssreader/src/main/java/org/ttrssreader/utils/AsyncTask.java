...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    /**
     * <p>
     * Attempts to cancel execution of this task. This attempt will fail if the task has already completed, already
     * been
     ...
     * still running. Each call to this method will trigger the execution of {@link #onProgressUpdate} on the UI
     * thread.
     *
